<div class="bg-red-400 mt-12 text-gray-900">
        ...
        <div class="border-gray-900 border-b">
            <div class="-mx-3 pb-5">
                <ul class="flex flex-wrap text-sm sm:text-base font-semibold leading-relaxed">
                    <li class="mx-3 mt-3">
                        <a href="/about"
                            class="border-b-2 border-transparent hover:border-gray-900 hover:border-b-2">About</a>
                    </li>
                    <li class="mx-3 mt-3">
                        <a href="/blog"
                    ...
                    <li class="mx-3 mt-3">
                        <a href="https://saas.transistor.fm"
                            class="border-b-2 border-transparent hover:border-gray-900 hover:border-b-2">Podcast</a>
                    </li>
                    <li class="mx-3 mt-3">
                        <a href="/privacy"
